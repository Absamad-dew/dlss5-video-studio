...
$Singles=@('app/studio.ps1','app/process-video.ps1','app/process-iw3.ps1','app/iw3-ui.ps1','app/iw3-settings.json',
    'tools/iw3/iw3_worker.py','tools/iw3/install_iw3.py','tools/iw3/iw3-lock.json',
    'scripts/Install-Iw3.ps1','scripts/New-PortableManifest.ps1','INSTALL_IW3.cmd',
    'IW3_VR_V22_1_RU.md','README_RU.md','THIRD_PARTY_NOTICES.md','VERSION_OPTIMIZED.txt')
...
try{
    ...
    try{$Writer.Write((@{version='22.1.0-iw3-vr';files=@($Manifest.ToArray())}|ConvertTo-Json -Depth 5))}finally{$Writer.Dispose()}
